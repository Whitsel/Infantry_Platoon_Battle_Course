...
call {	//Uniforms
	...
	BLU_UNIFORM_CONTENTS = [BLU_UNIFORM,[[BLU_MEDICAL,5]]];
};
...
call {	//Assemblies/Contents
	...
	call { // Contents
		...
		call {	//Combat Life Saver
			...
			BLU_PACK_CONTENTS_COMBATLIFESAVER = [BLU_PACK_ASSAULTPACK,[[BLU_MEDICAL,20]]];
		};
		call {	//Marksman
		...
		call {	//Platoon Medic
			...
			BLU_PACK_CONTENTS_MEDIC = [BLU_PACK_TACTICALPACK,[["Medikit",1],[BLU_MEDICAL,20]]];
		};
		call {	//Crewman
