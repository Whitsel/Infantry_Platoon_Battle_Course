...
call {	//Items
	...
	BLU_ITEMS = ["ItemMap","ItemGPS","rhsusf_radio_anprc152","ItemCompass","ItemWatch",""];
};
...
call {	//Assemblies/Contents
	call {	//Weapons
		...
		BLU_WEAP_SYS_RIFLE_MARKSMAN = [BLU_PRIMARY_RIFLE_MARKSMAN,"",BLU_RAIL_LASER_SIDE,BLU_OPTIC_MARK,[BLU_MAGAZINES_RIFLE_MARKSMAN,20],[],BLU_UNDERBARREL_RIFLE_AUTOMATIC];
		BLU_WEAP_SYS_RIFLE_MACHINEGUN = [BLU_PRIMARY_MACHINEGUN,BLU_MUZZLE_MACHINEGUN_FLASH,BLU_RAIL_LASER_SIDE,BLU_OPTIC_MGO,[BLU_MAGAZINES_MACHINEGUN,100],[],""];
	...
	call { // Contents
		...
		call {	//Marksman
			BLU_VEST_CONTENTS_MARKSMAN = [BLU_VEST_MARKSMAN,[[BLU_MAGAZINES_RIFLE_MARKSMAN,4,20],[BLUE_MAGAZINES_PISTOL,3,15],[BLU_GRENADE_FRAG,2,1],[BLU_GRENADE_SMOKE,4,1],[BLU_NVG,1]]];
			BLU_PACK_CONTENTS_MARKSMAN = [BLU_PACK_ASSAULTPACK,[[BLU_MAGAZINES_RIFLE_MARKSMAN,5,20]]];
		};
		call { //Team Leader
		...
		call {	//Machinegun Assistant
			...
			BLU_PACK_CONTENTS_MACHINEGUNASSISTANT = [BLU_PACK_TACTICALPACK,[[BLU_MAGAZINES_MACHINEGUN,6,100],[BLU_GRENADE_SMOKE_BLUE,2,1],[BLU_GRENADE_CHEM,2,1],[BLU_GRENADE_IR,2,1]]];
		};
		call {	//Machinegunner
		...
		call {	//Machinegun Ammo Bearer
			...
			BLU_PACK_CONTENTS_MACHINEGUNAMMOBEARER = [BLU_PACK_TACTICALPACK,[[BLU_MAGAZINES_MACHINEGUN,7,100]]];
		};
