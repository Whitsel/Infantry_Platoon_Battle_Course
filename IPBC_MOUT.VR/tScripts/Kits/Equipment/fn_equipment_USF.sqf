...
call {	//Assemblies/Contents
	...
	call { // Contents
		call {	//Rifleman
			BLU_VEST_CONTENTS_RIFLEMAN = [[BLU_MAGAZINES_RIFLE,7,30],[BLU_GRENADE_FRAG,2,1],[BLU_GRENADE_SMOKE,4,1],[BLU_NVG,1]];
			BLU_PACK_CONTENTS_RIFLEMAN = [];
		};
		call {	//Grenadier
			BLU_VEST_CONTENTS_GRENADIER = BLU_VEST_CONTENTS_RIFLEMAN;
			BLU_PACK_CONTENTS_GRENADIER = [[BLU_NVG,1],[BLU_MAGAZINES_GRENADIER_HE,11,1],[BLU_MAGAZINES_GRENADIER_SMOKE,4,1],[BLU_MAGAZINES_GRENADIER_FLARE,4,1]];
		};
		call {	//Automatic Rifleman
			BLU_VEST_CONTENTS_AUTOMATICRIFLEMAN = [[BLU_MAGAZINES_RIFLE_AUTOMATIC,1,200],[BLU_GRENADE_FRAG,2,1],[BLU_GRENADE_SMOKE,4,1],[BLU_NVG,1]];
			BLU_PACK_CONTENTS_AUTOMATICRIFLEMAN = [[BLU_MAGAZINES_RIFLE_AUTOMATIC,3,200]];
		};
		call {	//Combat Life Saver
			BLU_VEST_CONTENTS_COMBATLIFESAVER = BLU_VEST_CONTENTS_RIFLEMAN + [[BLU_GRENADE_CHEM_YELLOW,4,1],[BLU_GRENADE_CHEM_RED,4,1]];
			BLU_PACK_CONTENTS_COMBATLIFESAVER = [["FirstAidKit",20]];
		};
		call {	//Marksman
			BLU_VEST_CONTENTS_MARKSMAN = [[BLU_MAGAZINES_RIFLE_MARKSMAN,4,20],[BLUE_MAGAZINES_PISTOL,3,15],[BLU_GRENADE_FRAG,2,1],[BLU_GRENADE_SMOKE,4,1],[BLU_NVG,1]];
			BLU_PACK_CONTENTS_MARKSMAN = [[BLU_MAGAZINES_RIFLE_MARKSMAN,5,20]];
		};
		call { //Team Leader
			BLU_VEST_CONTENTS_TEAMLEADER = [[BLU_MAGAZINES_RIFLE_TRACER,7,30],[BLU_GRENADE_FRAG,2,1],[BLU_GRENADE_SMOKE,4,1],[BLU_NVG,1]];
			BLU_PACK_CONTENTS_TEAMLEADER = [[BLU_GRENADE_SMOKE_BLUE,2,1],[BLU_GRENADE_CHEM,2,1],[BLU_GRENADE_IR,2,1]];
		};
		call { //Squad Leader
		...
		call {	//Machinegun Assistant
			BLU_VEST_CONTENTS_MACHINEGUNASSISTANT = BLU_VEST_CONTENTS_TEAMLEADER;
			BLU_PACK_CONTENTS_MACHINEGUNASSISTANT = BLU_PACK_CONTENTS_TEAMLEADER + [BLU_MAGAZINES_MACHINEGUN,6,100]; //Needs BLU_PACK_TACTICALPACK
		};
		call {	//Machinegunner
			BLU_VEST_CONTENTS_MACHINEGUNNER = [[BLU_MAGAZINES_MACHINEGUN,2,100],[BLUE_MAGAZINES_PISTOL,3,15],[BLU_GRENADE_FRAG,2,1],[BLU_GRENADE_SMOKE,4,1],[BLU_NVG,1]];
			BLU_PACK_CONTENTS_MACHINEGUNNER = [[BLU_MAGAZINES_MACHINEGUN,3,100]];
		};
		call {	//Machinegun Ammo Bearer
			BLU_VEST_CONTENTS_MACHINEGUNAMMOBEARER = BLU_VEST_CONTENTS_RIFLEMAN;
			BLU_PACK_CONTENTS_MACHINEGUNAMMOBEARER = [[BLU_MAGAZINES_MACHINEGUN,7,100]]; //Needs BLU_PACK_TACTICALPACK
		};
		call {	//Anti Tank Gunner
			BLU_VEST_CONTENTS_ATGUNNER = BLU_VEST_CONTENTS_RIFLEMAN;
			BLU_PACK_CONTENTS_ATGUNNER = [[BLU_MAGAZINES_HAT_HE,2,1]];
		};
		call {	//Anti Tank Ammo Bearer
			BLU_VEST_CONTENTS_ATAMMOBEARER = BLU_VEST_CONTENTS_RIFLEMAN;
			BLU_PACK_CONTENTS_ATAMMOBEARER = [[BLU_MAGAZINES_HAT_AT,1,1],[BLU_MAGAZINES_HAT_HE,2,1]]; //Needs BLU_PACK_TACTICALPACK
		};
		call {	//Platoon Medic
			BLU_VEST_CONTENTS_MEDIC = BLU_VEST_CONTENTS_RIFLEMAN + [[BLU_GRENADE_CHEM_YELLOW,4,1],[BLU_GRENADE_CHEM_RED,4,1]];
			BLU_PACK_CONTENTS_MEDIC = [[BLU_NVG,1],["Medikit",1],["FirstAidKit",20]]; //Needs BLU_PACK_TACTICALPACK
		};
		call {	//Crewman
			BLU_VEST_CONTENTS_CREWMAN = BLU_VEST_CONTENTS_RIFLEMAN;
			BLU_PACK_CONTENTS_CREWMAN = [["MineDetector",1],["ToolKit",1]];
		};
		call {	//RATELO
