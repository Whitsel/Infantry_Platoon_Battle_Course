...
call {	//Items
	...
	BLU_RADIO = "rhsusf_radio_anprc152";
	BLU_GPS = "ItemGPS";
	BLU_BINO = ["rhsusf_bino_m24","","","",[],[],""];
	BLU_ITEMS_LEADER = ["ItemMap",BLU_GPS,BLU_RADIO,"ItemCompass","ItemWatch",""];
	BLU_ITEMS_TROOPER = ["ItemMap","","","ItemCompass","ItemWatch",""];
};
...
call {	//Uniforms
	...
	BLU_UNIFORM_CONTENTS_TROOPER = [BLU_UNIFORM,[["FirstAidKit",5]]];
	BLU_UNIFORM_CONTENTS_LEADER = [BLU_UNIFORM,[["FirstAidKit",5]]];
};
...
call {	//Assemblies/Contents
	call {	//Weapons
		...
		BLU_WEAP_SYS_RIFLE_MARKSMAN = [BLU_PRIMARY_RIFLE_MARKSMAN,"",BLU_RAIL_LASER_SIDE,BLU_OPTIC_MARK,[BLU_MAGAZINES_RIFLE_MARKSMAN,20],[],""];
	...
	call { // Contents
		...
		call {	//Grenadier
			BLU_VEST_CONTENTS_GRENADIER = [BLU_VEST_RIFLEMAN,[[BLU_MAGAZINES_RIFLE,7,30],[BLU_GRENADE_FRAG,2,1],[BLU_GRENADE_SMOKE,4,1],[BLU_NVG,1]]];
			BLU_PACK_CONTENTS_GRENADIER = [BLU_PACK_ASSAULTPACK,[[BLU_NVG,1],[BLU_MAGAZINES_GRENADIER_HE,11,1],[BLU_MAGAZINES_GRENADIER_SMOKE,4,1],[BLU_MAGAZINES_GRENADIER_FLARE,4,1]]];
		};
		...
		call {	//Combat Life Saver
			BLU_VEST_CONTENTS_COMBATLIFESAVER = [BLU_VEST_RIFLEMAN,[[BLU_MAGAZINES_RIFLE,7,30],[BLU_GRENADE_FRAG,2,1],[BLU_GRENADE_SMOKE,4,1],[BLU_GRENADE_CHEM_YELLOW,4,1],[BLU_GRENADE_CHEM_RED,4,1],[BLU_NVG,1]]];
			BLU_PACK_CONTENTS_COMBATLIFESAVER = [BLU_PACK_ASSAULTPACK,[["FirstAidKit",20]]];
		};
		call {	//Marksman
		...
		call {	//Machinegun Assistant
			...
			BLU_PACK_CONTENTS_MACHINEGUNASSISTANT = [BLU_PACK_ASSAULTPACK,[[BLU_MAGAZINES_MACHINEGUN,6,100],[BLU_GRENADE_SMOKE_BLUE,2,1],[BLU_GRENADE_CHEM,2,1],[BLU_GRENADE_IR,2,1]]];
		};
		call {	//Machinegunner
		...
		call {	//Platoon Medic
			BLU_VEST_CONTENTS_MEDIC = [BLU_VEST_RIFLEMAN,[[BLU_MAGAZINES_RIFLE,7,30],[BLU_GRENADE_FRAG,2,1],[BLU_GRENADE_SMOKE,4,1],[BLU_GRENADE_CHEM_YELLOW,4,1],[BLU_GRENADE_CHEM_RED,4,1],[BLU_NVG,1]]];
			BLU_PACK_CONTENTS_MEDIC = [BLU_PACK_TACTICALPACK,[[BLU_NVG,1],["Medikit",1],["FirstAidKit",20]]];
		};
		call {	//Crewman
