...
_object addAction ["<t color='#C9FFC9'>Grid Reminder</t>", {
	...
	true,		// hideOnUse
	"",	// shortcut
	"(player getVariable ['lane_4',false]) && (4 == (player getVariable ['points', 0]))", 	// condition
	5,	// radius
	false,		// unconscious
	"",	// selection
	""	// memoryPoint
...
_object addAction ["<t color='#C9FFC9'>Claim Point</t>", {
	...
	true,		// hideOnUse
	"",	// shortcut
	"(player getVariable ['lane_11',false]) && (3 == (player getVariable ['points', 0]))", 	// condition
	5,	// radius
	false,		// unconscious
	"",	// selection
	""	// memoryPoint
...
_object addAction ["<t color='#C9FFC9'>Grid Reminder</t>", {
	...
	true,		// hideOnUse
	"",	// shortcut
	"(player getVariable ['lane_11',false]) && (4 == (player getVariable ['points', 0]))", 	// condition
	5,	// radius
	false,		// unconscious
	"",	// selection
	""	// memoryPoint
